...
yas-exam模考试系统是一款 java + vue 的前后端分离的考试系统。主要优点是开发、部署简单快捷、界面设计友好、代码结构清晰。支持web端和微信小程序，能覆盖到pc机和手机等设备。
...
| 环境   | 版本 | 下载地址                                                     |
| ------ | ---- | ------------------------------------------------------------ |
| NodeJs | 16   | [https://nodejs.org/download/release/latest-v16.x/open in new window](https://nodejs.org/download/release/latest-v16.x/) |
| Jdk    | 1.8  | [https://www.oracle.com/java/technologies/downloads/#java8-windowsopen in new window](https://www.oracle.com/java/technologies/downloads/#java8-windows) |
| Mysql  | 8.0  | [https://dev.mysql.com/downloads/windows/installer/8.0.htmlopen in new window](https://dev.mysql.com/downloads/windows/installer/8.0.html) |

### [#](https://www.mindskip.net:999/guide/develop.html#_5-2-开发说明)5.2 开发说明

- 数据库sql/yas_exam.sql，创建表初始化数据，数据库名称为yas_exam
- 代码下载 mysql版本，配合相应的数据库使用
- 安装mysql ，导入yas_exam.sql脚本
- 学生端默认账号：student / 123456
- 管理端默认账号：admin / 123456

### [#](https://www.mindskip.net:999/guide/develop.html#_5-3-后端开发)5.3 后端开发
...
- 启动后台程序,默认端口为8000
- 学生系统地址：[http://ip:8000/studentopen in new window](http://ip:8000/student)
- 管理端地址：[http://ip:8000/adminopen in new window](http://ip:8000/admin)

### [#](https://www.mindskip.net:999/guide/develop.html#_5-4-前端开发)5.4 前端开发

- 在win11系统中输入命令，低版本的win会出现不兼容的问题，无法执行对应的命令。
- 前端使用webstorm或者vscode，分别打开文件夹打开源代码\yas-exam-student和yas-exam-admin
...
### [#](https://www.mindskip.net:999/guide/develop.html#_5-5-小程序开发)5.5 小程序开发
...
### [#](https://www.mindskip.net:999/guide/develop.html#_5-6-代码结构简介)5.6 代码结构简介

#### [#](https://www.mindskip.net:999/guide/develop.html#_5-6-1-后端系统)5.6.1 后端系统
...
#### [#](https://www.mindskip.net:999/guide/develop.html#_5-6-2-学生端)5.6.2 学生端
...
#### [#](https://www.mindskip.net:999/guide/develop.html#_5-6-3-微信端)5.6.3 微信端
...
#### [#](https://www.mindskip.net:999/guide/develop.html#_5-6-4-管理端)5.6.4 管理端
